...
export function HowItWorks() {
  ...
  return <TrainingChatProvider><section ref={sectionRef} id="how-it-works" className={styles.section} aria-labelledby="how-heading">
    ...
    <div className={`${styles.frame} ${styles.headingFrame}`}><div className={styles.intro}><p>How it works</p><h2 id="how-heading">Film-based coaching.<br />Real work translated onto the court</h2></div></div>
