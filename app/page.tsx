      ...
      <main className="flex w-full flex-col">
        ...
        {(() => {
          const STEPS = [
            ...
            { slug: '100-days',     label: 'The 100 Days', num: '03', title: "One review isn't enough to change your game.", body: "100 days. Weekly calls. Jaiden's watching your film change in real time, right alongside you.",                              image: 'the-100-days.webp', imagePosition: 'center 45%' },
