  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="flex w-full flex-col">
        ...
        {(() => {
          const STEPS = [
            { slug: 'diagnosis',    label: 'Diagnosis',    num: '01', title: 'Get assessed like a recruiter would.',       body: "Send your best film. Jaiden watches it like a scout, draws directly on it, tells you exactly what he sees and what to fix. No cold drills, no standardized test. Just your actual game, evaluated honestly.", image: 'film-study-hero.png' },
            { slug: 'prescription', label: 'Prescription', num: '02', title: "Your weakness, not everyone else's workout.", body: "Every drill you get is pulled straight from what Jaiden saw in your film, the exact things standing between you and an offer.",                                                                                image: 'drill-library-3.png' },
