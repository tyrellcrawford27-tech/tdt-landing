...
const PROGRAM_STEPS: ProgramStep[] = [
  ...
  { slug: 'prescription', label: 'Prescription', num: '02', icon: 'pillbottle',  title: "The fix begins.", body: <>Jaiden pulls what <You>you</You> work on straight from <You>your</You> film. Then he explains to <You>you</You> one-on-one exactly what <You>you</You> need to do to make it translate into real games.</>, image: 'drill-true.webp' },
